...
export default function Home() {
  ...
  const [privacyClicked, setPrivacyClicked] = useState<boolean>(false);
  ...
  return (
    <div className="mx-auto flex min-h-[100vh] max-w-md flex-col items-center">
      ...
      <div>
        ...
        {privacyClicked && (
          <>
            <div className="mt-4 border border-solid border-gray-300 bg-gray-200 px-2 py-3 text-sm">
              개인정보 수집 및 이용안내
            </div>
            <div className="h-20 w-[300px] overflow-y-auto whitespace-pre-wrap border border-solid border-gray-300 px-1 py-2 text-xs">
              {`
[차례]
1. 총칙
2. 개인정보 수집에 대한 동의
...
1) 공고일자 : 2023년 12월 27일
2) 시행일자 : 2023년 12월 27일 
                  `}
            </div>
          </>
        )}
        ...
        {serviceClicked && (
          <>
            ...
            <div className="h-20 w-[300px] overflow-y-auto whitespace-pre-wrap border border-solid border-gray-300 px-1 py-2 text-xs">
              {`
제1조(목적) 이 약관은 마이멤버쉽 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
        ...
        <div className="mt-5 flex w-[300px] flex-row space-x-2">
          <input
            type="checkbox"
            checked={checked}
